...
Entrypoint for Qwen agents working in **strict-next-ranger**, a strict Next.js 16 frontend operating system. Canonical sources: [AGENTS.md](AGENTS.md), [context/architecture-map.md](context/architecture-map.md), [rules/00-non-negotiable-rules.md](rules/00-non-negotiable-rules.md).
