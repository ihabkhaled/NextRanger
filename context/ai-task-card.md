...
| ------------------ | --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------- |
| Page or route      | `src/app/<group>/`                                        | rules/01 + skills/add-route                               | `npm run typecheck:app`           |
...
| Release proof      | no source changes                                         | rules/19 + skills/final-validation                        | `npm run quality`                 |
...
3. Run the smallest relevant test, then lint and typecheck. Expand to release gates only after
   focused checks pass.
