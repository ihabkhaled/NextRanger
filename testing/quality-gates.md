...
| Dependency vulnerabilities                                | `npm run security:audit` (`npm audit --audit-level=low`)                                                                     | `.github/workflows/security.yml`                                                    | Yes — zero unhandled findings; fixes follow the pattern of the documented `postcss` override in `package.json` |
...
| Circular dependencies                                     | `npm run quality:circular` (madge over `src`)                                                                                | `ci.yml`                                                                            | Yes                                                                                                            |
